...
bool operator==(const ::rwth_perception_people_msgs::GroundPlane_<ContainerAllocator1> & lhs, const ::rwth_perception_people_msgs::GroundPlane_<ContainerAllocator2> & rhs)
{
