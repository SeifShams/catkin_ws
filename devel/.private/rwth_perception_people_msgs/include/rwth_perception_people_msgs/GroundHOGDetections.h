...
struct GroundHOGDetections_
{
  ...
  _header_type header;
   ...
   typedef std::vector<int64_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int64_t>> _pos_x_type;
  _pos_x_type pos_x;

   typedef std::vector<int64_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int64_t>> _pos_y_type;
  _pos_y_type pos_y;

   typedef std::vector<int64_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int64_t>> _width_type;
  _width_type width;

   typedef std::vector<int64_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int64_t>> _height_type;
  _height_type height;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _scale_type;
  _scale_type scale;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _score_type;
  _score_type score;
...
bool operator==(const ::rwth_perception_people_msgs::GroundHOGDetections_<ContainerAllocator1> & lhs, const ::rwth_perception_people_msgs::GroundHOGDetections_<ContainerAllocator2> & rhs)
{
