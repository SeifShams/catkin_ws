...
struct AnnotatedFrame_
{
  ...
  _timestamp_type timestamp;
   ...
   typedef std::vector< ::rwth_perception_people_msgs::Annotation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rwth_perception_people_msgs::Annotation_<ContainerAllocator> >> _annotations_type;
