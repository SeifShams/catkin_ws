...
if __name__ == '__main__':
    ...
    show_case = Robot()
    while not rospy.has_param("/tug_test_cases/navigation_pose"):
        pass
    nav_pose = rospy.get_param("/tug_test_cases/navigation_pose")
    rospy.loginfo("Press ENTER to continue...")
    input()
    start_position = show_case.current_position
    show_case.move_to_goal(nav_pose)
    show_case.fine_position(1.5, 0.3, 1)
    rospy.sleep(3)
    show_case.fine_position(0.3, 1.5, 1)
    show_case.move_to_goal(start_position)
