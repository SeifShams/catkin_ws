...
struct LaserscanSegment_
{
  ...
  _label_type label;
   ...
   typedef std::vector<uint16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint16_t>> _measurement_indices_type;
...
bool operator==(const ::srl_laser_segmentation::LaserscanSegment_<ContainerAllocator1> & lhs, const ::srl_laser_segmentation::LaserscanSegment_<ContainerAllocator2> & rhs)
{
  return lhs.label == rhs.label &&
    lhs.measurement_indices == rhs.measurement_indices;
}
