...
struct qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool_t {
    QByteArrayData data[1];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool_t qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool = {
    {
QT_MOC_LITERAL(0, 0, 41) // "track_annotation_tool::Delete..."

    },
    "track_annotation_tool::DeleteWaypointTool"
};
...
QT_INIT_METAOBJECT const QMetaObject track_annotation_tool::DeleteWaypointTool::staticMetaObject = { {
    &rviz::Tool::staticMetaObject,
    qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool.data,
    qt_meta_data_track_annotation_tool__DeleteWaypointTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *track_annotation_tool::DeleteWaypointTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_track_annotation_tool__DeleteWaypointTool.stringdata0))
