...
get_filename_component(_filename "/home/seif/catkin_ws/src/spencer_people_tracking/detection/spencer_detected_person_association/srv/LookupTrackId.srv" NAME_WE)
add_custom_target(_spencer_detected_person_association_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "spencer_detected_person_association" "/home/seif/catkin_ws/src/spencer_people_tracking/detection/spencer_detected_person_association/srv/LookupTrackId.srv" ""
)

get_filename_component(_filename "/home/seif/catkin_ws/src/spencer_people_tracking/detection/spencer_detected_person_association/srv/LookupTrackIds.srv" NAME_WE)
add_custom_target(_spencer_detected_person_association_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "spencer_detected_person_association" "/home/seif/catkin_ws/src/spencer_people_tracking/detection/spencer_detected_person_association/srv/LookupTrackIds.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spencer_detected_person_association)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spencer_detected_person_association\")")
  # install generated code
  install(
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spencer_detected_person_association")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spencer_detected_person_association
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
